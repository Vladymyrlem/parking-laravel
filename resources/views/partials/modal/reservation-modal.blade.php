                        ...
                        <div class="checkout-personal-info">
                            ...
                            <div class="row">
                                <div class="form-group all">
                                    ...
                                    <div class="checkbox">
                                        <input id="checkout_approval_1" type="checkbox" name="checkout_approval_1" class="form_element" value="yes" data-rule="checked"
                                               data-msg="musisz wyrazić zgodę na przetwarzanie swoich danych osobowych">
                                        <label for="checkout_approval_1">Wyrażam zgodę na przetwarzanie moich danych osobowych<span class="subtitle">Zgodnie z art.6 ust.1 lit. a ogólnego rozporządzenia o ochronie danych osobowych z dnia 27 kwietnia 2016 r. wyrażam zgodę na przetwarzanie moich danych osobowych w celach marketingowych.</span></label>
