        ...
        <table class="table table-striped table-hover table-responsive-lg">
            ...
            <?php $__currentLoopData = $section_title; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $title): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <tr id="sectiontitle-<?php echo e($title->id); ?>" class="active">
                    ...
                    <td width="220px">
                        <button class="btn btn-warning btn-detail open_section_title_modal" value="<?php echo e($title->id); ?>">Edycja nagłówku</button>
                        <button class="btn btn-danger btn-delete delete-section-title" value="<?php echo e($title->id); ?>">Usuń nagłówek</button>
                    </td>
                </tr>
